(function() {
    var Help = function(json) {
      ...
      this.el.append('<div class="box">' +
        ...
        "<p>Press <b>Control+click</b> to select a view. Escape unfocuses. Use the arrow keys to move a view. Use Control+arrow to <i>split</i> a view in the given direction.</p>" +
